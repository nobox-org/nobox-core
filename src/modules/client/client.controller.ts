...
export class ClientController {
    constructor(private readonly epService: ClientService, private readonly clientFunctionsService: ClientFunctionsService) { }
    ...
    async processFunction(@Param() params: FunctionDto, @Body() body: Record<string, any>) {
        return await this.clientFunctionsService.processFunction({ params, body });
    }
}
